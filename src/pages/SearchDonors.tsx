...
import { Search, MapPin, Phone, Calendar, Star, CheckCircle } from 'lucide-react';
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                ...
                <div className="rounded-lg bg-muted/50 p-2">
                  <div className="text-lg font-bold">
                    {d.lastDonationDate ? Math.floor((Date.now() - new Date(d.lastDonationDate).getTime()) / 86400000) + 'd' : '—'}
                  </div>
