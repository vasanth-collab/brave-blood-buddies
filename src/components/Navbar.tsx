...
import { Droplets, Menu, X, LogOut, User, LayoutDashboard, Search, PlusCircle, Inbox } from 'lucide-react';
...
const NAV_LINKS = [
  ...
  { to: '/assignments', label: 'My Assignments', icon: Inbox },
...
export default function Navbar() {
  ...
  const links = authUser ? NAV_LINKS : [];
